...
// ----------------------------------------------------------------------
// SAMPLE PAGE
const SamplePage1 = lazy(() => import('src/pages/dashboard/samplePage1'));
const SamplePage2 = lazy(() => import('src/pages/dashboard/samplePage2'));
// FORM EX
const FormExViewPage = lazy(() => import('src/pages/dashboard/formEx'));
// BOARD
